...
int main(int argc, char const **argv)
{
  ...
  calibrateCamera(obj_points, img_points, img.size(), K, D, rvecs, tvecs, flag);

  cout << "Calibration error: " << computeReprojectionErrors(obj_points, img_points, rvecs, tvecs, K, D) << endl;
